defmodule SynapsisServerWeb.SessionChannelTest do
  use SynapsisServerWeb.ChannelCase

  alias SynapsisServerWeb.UserSocket
  ...
  setup do
    ...
    {:ok, _, socket} =
      UserSocket
      |> socket("user_id", %{})
      |> subscribe_and_join(SynapsisServerWeb.SessionChannel, "session:#{session.id}")
