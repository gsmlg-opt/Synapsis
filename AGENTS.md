...
This project is indexed by GitNexus as **Synapsis** (2511 symbols, 2571 relationships, 6 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
