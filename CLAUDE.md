...
- Phoenix LiveView + Tailwind CSS v4
- `phoenix_duskmoon` (Phoenix component library)
- `@duskmoon-dev/core` (Tailwind CSS plugin)
- Req + Finch for HTTP
...
This project is indexed by GitNexus as **Synapsis** (2783 symbols, 2956 relationships, 13 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
