# Graph Report - Synapsis  (2026-05-18)

## Corpus Check
- 721 files · ~259,993 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4427 nodes · 5152 edges · 687 communities (297 shown, 390 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 61 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e181e117`
...
1. `SynapsisWeb.AgentLive.Agents` - 62 edges
2. `Synapsis.Sessions` - 43 edges
3. `add()` - 40 edges
4. `Synapsis.Tool.Registry` - 31 edges
5. `Synapsis.WorkspaceDocuments` - 31 edges
6. `Synapsis.Providers` - 31 edges
7. `Synapsis.Harness.Loop` - 27 edges
8. `Synapsis.Agent.Runtime.Runner` - 27 edges
9. `Synapsis.Workspace.Projection` - 27 edges
10. `SynapsisWeb.AssistantLive.Setting` - 25 edges
...
Cohesion: 0.06
Nodes (53): SynapsisWeb.AgentLive.Agents, agent_config_map(), agent_form(), agent_label(), agent_option_label(), agent_tool_names(), apply_action(), assign_common() (+45 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (33): Synapsis.Sessions, agent_config(), blank?(), compact(), create(), default_model(), default_provider(), delete() (+25 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (11): CrashProcessServer, CrashTool, DisabledExecTool, ErrorTool, FakeToolServer, SideEffectTool, SlowProcessServer, SlowTool (+3 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (32): Synapsis.Agent.Memory.EventStore, to_event(), Synapsis.Agent.Memory.SummaryStore, get(), to_summary(), Synapsis.Providers, authenticate(), build_runtime_config() (+24 more)

### Community 5 - "Community 5"
Cohesion: 0.11
Nodes (23): Synapsis.Tool.Registry, enrich_opts_from_module(), entry_opts(), entry_to_llm_map(), entry_to_query_loop_map(), filter_agent_mode(), filter_deferred(), filter_enabled() (+15 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (6): DisabledTool, ExecuteTool, FakeTool, SearchTool, Synapsis.Tool.RegistryTest, WriteTool

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (14): Synapsis.WorkspaceDocuments, apply_path_prefix(), get(), glob(), glob_to_like(), grep(), hard_delete_by_ids(), insert() (+6 more)

### Community 8 - "Community 8"
Cohesion: 0.13
Nodes (26): Synapsis.Agent.Runs, attr(), get(), list_recent(), mark_cancelled(), mark_running(), mark_waiting_approval(), recover_stale_running_runs() (+18 more)
...
Cohesion: 0.11
Nodes (7): SynapsisWeb.SessionLive.Show, derive_mode(), fetch_provider_models(), handle_event(), load_debug_entries(), load_debug_entries_from_store(), mount()

### Community 20 - "Community 20"
Cohesion: 0.15
Nodes (15): Synapsis.Memory, apply_checkpoint_filters(), apply_event_filters(), apply_semantic_filters(), archive_semantic(), count_events(), count_semantic(), list_checkpoints() (+7 more)

### Community 21 - "Community 21"
Cohesion: 0.19
Nodes (18): Synapsis.Agent.QueryLoop, build_assistant_message(), build_request(), build_tool_map(), collect_loop(), collect_loop_streaming(), collect_with_streaming(), do_turn() (+10 more)

### Community 22 - "Community 22"
Cohesion: 0.2
Nodes (19): Synapsis.Provider.Adapter, anthropic_auth_headers(), complete(), do_complete(), do_openai_complete(), do_openai_stream(), do_stream(), emit_error_telemetry() (+11 more)

### Community 23 - "Community 23"
Cohesion: 0.1
Nodes (5): MinimalPlugin, MinimalPlugin2, MinimalPlugin3, OverridingPlugin, SynapsisPlugin.PluginBehaviourTest

### Community 24 - "Community 24"
Cohesion: 0.1
Nodes (4): AbortEchoTool, EchoTool, FailTool, Synapsis.Agent.QueryLoopTest

### Community 25 - "Community 25"
Cohesion: 0.18
Nodes (18): Synapsis.Agent.ContextBuilder, build_assigned_skills(), build_coding_context(), build_skills_manifest(), build_system_prompt(), default_base_prompt(), format_assigned_skill(), load_base_prompt() (+10 more)

### Community 26 - "Community 26"
Cohesion: 0.11
Nodes (14): Synapsis.Agent.Nodes.ApprovalGate, handle_initial(), handle_resumed(), run(), Synapsis.Agent.Nodes.Escalate, run(), Synapsis.Agent.Nodes.Helpers, worker_pid() (+6 more)

### Community 27 - "Community 27"
Cohesion: 0.1
Nodes (4): ErrorTool, ReadTool, Synapsis.Agent.QueryLoop.ExecutorTest, WriteTool

### Community 28 - "Community 28"
Cohesion: 0.17
Nodes (14): Synapsis.Workspace, broadcast_change(), delete(), list(), maybe_load_blob(), move(), read(), read_by_id() (+6 more)

### Community 29 - "Community 29"
Cohesion: 0.17
Nodes (12): Synapsis.Tool.Task, build_subagent_prompt(), collect_session_result(), execute(), execute_background(), execute_foreground(), execute_via_query_loop(), extract_subagent_response() (+4 more)

### Community 30 - "Community 30"
Cohesion: 0.11
Nodes (4): MockDeferredTool, MockFileTool, MockSearchTool, Synapsis.Tool.ToolSearchTest

### Community 31 - "Community 31"
Cohesion: 0.18
Nodes (12): SynapsisWeb.MCPLive.Index, apply_action(), handle_event(), handle_info(), handle_params(), import_mcp_servers(), list_configs(), load_plugin_states() (+4 more)

### Community 32 - "Community 32"
Cohesion: 0.15
Nodes (9): SynapsisWeb.WorkspaceLive.Explorer, extract_project_id(), handle_event(), handle_params(), mount(), promotable?(), promote_path(), resubscribe_workspace_changes() (+1 more)

### Community 33 - "Community 33"
Cohesion: 0.21
Nodes (16): Synapsis.Workspace.GC, blob_ref_to_path(), blob_store_module(), blob_store_root(), cleanup_orphaned_blobs(), cleanup_session_scratch(), do_gc(), gc_config() (+8 more)

### Community 34 - "Community 34"
Cohesion: 0.18
Nodes (13): SynapsisServer.SessionController, compact(), create(), create_session(), export_session(), fork(), fork_session(), format_changeset_errors() (+5 more)

### Community 35 - "Community 35"
Cohesion: 0.18
Nodes (13): SynapsisPlugin.LSP, execute(), format_lsp_result(), handle_info(), handle_lsp_message(), init(), position_params(), process_buffer() (+5 more)

### Community 36 - "Community 36"
Cohesion: 0.23
Nodes (11): Synapsis.Tool.Teammate, create_teammate(), delete_all(), ensure_table(), execute(), get_teammate(), list_teammates(), load_teammates() (+3 more)

### Community 37 - "Community 37"
Cohesion: 0.26
Nodes (16): Synapsis.Tool.VFS, add_prefix(), apply_offset_limit(), delete(), extract_content(), extract_kind(), extract_path(), glob() (+8 more)

### Community 38 - "Community 38"
Cohesion: 0.12
Nodes (3): CustomTool, DefaultTool, Synapsis.Tool.BehaviourTest

### Community 39 - "Community 39"
Cohesion: 0.15
Nodes (10): SynapsisServer.SessionChannel, format_error(), handle_in(), join(), load_debug_state(), Synapsis.AgentSkills, list_agent_ids(), list_agents_for_skill_id() (+2 more)

### Community 40 - "Community 40"
Cohesion: 0.22
Nodes (14): SynapsisWeb.AgentLive.Toolsets, apply_action(), assign_common(), available_tool_groups(), available_tools(), category_index(), category_label(), handle_event() (+6 more)

### Community 41 - "Community 41"
Cohesion: 0.18
Nodes (12): Phoenix.MixProject, aliases(), application(), deps(), docs(), elixirc_paths(), extra_applications(), extras() (+4 more)
...
Cohesion: 0.2
Nodes (12): Synapsis.Agent.Resolver, apply_project_agent_config(), blank?(), default_name(), default_system_prompt(), from_db(), from_default(), model_tier() (+4 more)

### Community 44 - "Community 44"
Cohesion: 0.23
Nodes (13): AgentConfigCompat, SynapsisWeb.ChatLive, assign_chat_data(), default_agent_name(), global_session?(), handle_event(), handle_info(), handle_params() (+5 more)
...
Cohesion: 0.26
Nodes (13): Synapsis.Agent.StreamingExecutor, add_tool(), check_completions(), concurrent_safe?(), format_result(), get_completed_results(), get_remaining_results(), maybe_start_tools() (+5 more)

### Community 51 - "Community 51"
Cohesion: 0.22
Nodes (9): Synapsis.Session.Worker.IOHandler, detach_debug(), handle_provider_done(), handle_provider_error(), handle_start_stream(), handle_tool_result(), maybe_attach_debug(), safe_resume() (+1 more)
...
Cohesion: 0.15
Nodes (10): Synapsis.Repo.Migrations.CreateAgentCheckpoints, change(), Synapsis.Repo.Migrations.AlterSessionPermissionsToEnum, down(), up(), Synapsis.Repo.Migrations.CreateRepoWorktrees, change(), Synapsis.Repo.Migrations.CreateHarnessEvents (+2 more)
...
Cohesion: 0.16
Nodes (5): Synapsis.Provider.OAuth.OpenAI, build_token_config(), parse_interval(), refresh_token(), request_user_code()

### Community 59 - "Community 59"
Cohesion: 0.2
Nodes (8): Synapsis.Agent.ProjectAssistant, handle_call(), handle_info(), maybe_append_routing_decision(), maybe_start_next(), run_graph(), start_link(), via()

### Community 60 - "Community 60"
Cohesion: 0.14
Nodes (3): FastReadTool, SlowWriteTool, Synapsis.Agent.StreamingExecutorTest

### Community 61 - "Community 61"
Cohesion: 0.14
Nodes (3): SubagentEchoTool, SubagentTaskTool, Synapsis.Agent.QueryLoopForkTest

### Community 62 - "Community 62"
Cohesion: 0.22
Nodes (9): Synapsis.Workspace.Resources, create_document(), draft_version_retention(), get_by_path(), hash_content(), maybe_create_version(), maybe_put(), update_document() (+1 more)

### Community 63 - "Community 63"
Cohesion: 0.24
Nodes (9): Synapsis.Workspace.Identity, load_all(), load_bootstrap(), load_identity(), load_project_context(), load_soul(), read_content(), seed_defaults() (+1 more)

### Community 64 - "Community 64"
Cohesion: 0.23
Nodes (11): ExDoc.Mixfile, aliases(), application(), deps(), docs(), elixirc_paths(), escript(), extra_applications() (+3 more)

### Community 65 - "Community 65"
Cohesion: 0.28
Nodes (11): Synapsis.Config, deep_merge(), default_system_prompt(), defaults(), load_auth(), load_env_overrides(), load_json_file(), load_project_config() (+3 more)

### Community 66 - "Community 66"
Cohesion: 0.21
Nodes (8): Synapsis.DevLog, append(), filter(), finalize_entry(), format_time(), matches_filter?(), parse_lines(), parse_timestamp()

### Community 67 - "Community 67"
Cohesion: 0.23
Nodes (8): Synapsis.Board, find_card_index(), get_card(), get_id(), move_card(), remove_card(), update_card(), validate_transition()

### Community 68 - "Community 68"
Cohesion: 0.22
Nodes (7): Synapsis.Tool.SessionSummarize, execute(), extract_heuristic(), extract_text(), extract_via_llm(), load_messages(), parse_llm_candidates()

### Community 69 - "Community 69"
Cohesion: 0.23
Nodes (7): Synapsis.Tool.AgentDiscover, execute(), find_by_project(), format_value(), get_agent(), list_agents(), maybe_filter_type()

### Community 70 - "Community 70"
Cohesion: 0.22
Nodes (7): Synapsis.Tool.Grep, build_command(), build_grep_command(), build_rg_command(), collect_output(), execute(), execute_search()

### Community 71 - "Community 71"
Cohesion: 0.21
Nodes (6): Synapsis.Tool.MultiEdit, apply_edits_sequentially(), apply_edits_to_file(), apply_vfs_edits(), execute(), resolve_path()

### Community 72 - "Community 72"
Cohesion: 0.23
Nodes (7): Synapsis.Tool.Fetch, execute(), fetch_url(), private_addr?(), private_ip?(), resolves_to_private?(), validate_url()

### Community 73 - "Community 73"
Cohesion: 0.22
Nodes (7): Synapsis.Tool.BoardRead, default_columns(), execute(), filter_cards(), maybe_filter_column(), maybe_filter_label(), maybe_filter_repo()

### Community 74 - "Community 74"
Cohesion: 0.21
Nodes (6): Synapsis.Memory.Writer, extract_session_id(), handle_info(), importance_for(), map_tool_effect(), persist_event()

### Community 75 - "Community 75"
Cohesion: 0.32
Nodes (12): SynapsisCli.Main, create_session(), interactive_loop(), main(), parse_sse_event(), print_help(), process_sse_data(), put_if_present() (+4 more)

### Community 76 - "Community 76"
Cohesion: 0.21
Nodes (7): SynapsisWeb.ProviderLive.Show, build_chat_request(), fetch_models(), format_chat_message(), handle_info(), handle_oauth_authorized(), mount()

### Community 77 - "Community 77"
Cohesion: 0.23
Nodes (9): Synapsis.ToolApproval, changeset(), create(), find_by_pattern(), list_by_scope(), maybe_filter(), update(), upsert() (+1 more)

### Community 78 - "Community 78"
Cohesion: 0.26
Nodes (8): Synapsis.Agent.RunEvents, append(), append_agent_event(), append_memory_event(), append_tool_event(), base_payload(), log_failure(), memory_scope()

### Community 79 - "Community 79"
Cohesion: 0.21
Nodes (7): Synapsis.Agent.Runtime.Graph, ensure_destination(), resolve_direct_destination(), validate(), validate_edges(), validate_nodes(), validate_start()

### Community 80 - "Community 80"
Cohesion: 0.22
Nodes (10): Nodes.Execute, run(), Nodes.Route, run(), Nodes.Summarize, failure(), run(), Synapsis.Agent.Runtime.ProjectGraph (+2 more)

### Community 81 - "Community 81"
Cohesion: 0.29
Nodes (12): Synapsis.Agent.Heartbeat.Worker, await_session_completion(), create_heartbeat_session(), execute_heartbeat(), extract_text_content(), fetch_last_assistant_response(), flush_mailbox(), format_error() (+4 more)

### Community 82 - "Community 82"
Cohesion: 0.15
Nodes (6): ApprovalNode, ExecutorNode, FinishNode, MissingEdgeNode, PlannerNode, Synapsis.Agent.Runtime.RunnerTest

### Community 83 - "Community 83"
Cohesion: 0.21
Nodes (5): Synapsis.Tool.AgentInbox, execute(), get_history(), get_thread(), get_unread()

### Community 84 - "Community 84"
Cohesion: 0.21
Nodes (5): Synapsis.Tool.FileEdit, execute(), execute_fs_edit(), execute_vfs_edit(), resolve_path()

### Community 85 - "Community 85"
Cohesion: 0.21
Nodes (5): Synapsis.Tool.MemorySave, broadcast_memory_promoted(), execute(), infer_scope(), scope_id_for()

### Community 86 - "Community 86"
Cohesion: 0.21
Nodes (5): Synapsis.Tool.BoardUpdate, apply_action(), execute(), load_board(), persist_board()

### Community 87 - "Community 87"
Cohesion: 0.29
Nodes (11): Synapsis.Memory.SummarizerDispatcher, check_threshold(), compress_messages(), enqueue(), extract_via_llm(), load_messages(), load_session(), maybe_put() (+3 more)

### Community 88 - "Community 88"
Cohesion: 0.26
Nodes (8): Synapsis.Harness.Context, apply_event(), apply_usage(), committed_part_update?(), deep_merge(), delete_accumulating_part(), maybe_clear_assistant_message(), update_message()

### Community 89 - "Community 89"
Cohesion: 0.17
Nodes (11): BudgetTick, PermissionDenied, PermissionGranted, ProviderError, ProviderEvent, Synapsis.Harness.Loop.Input, ToolCompleted, ToolFailed (+3 more)

### Community 91 - "Community 91"
Cohesion: 0.24
Nodes (6): Synapsis.Agent.GlobalAssistant, ensure_project(), handle_call(), map_by_project_id(), metadata_value(), sync_project_state()

### Community 92 - "Community 92"
Cohesion: 0.24
Nodes (8): Synapsis.Agent.GlobalAgent, cancel(), fetch_session_summary(), get_status(), handle_info(), noreply_from_io(), send_message(), via()
...
Cohesion: 0.36
Nodes (6): Synapsis.AgentCheckpoints, apply_filters(), json_safe(), list(), serialize_attrs(), serialize_error()

### Community 188 - "Community 188"
Cohesion: 0.39
Nodes (6): Synapsis.WorkspaceDocument, changeset(), create_changeset(), update_changeset(), validate_lifecycle_transition(), validate_path()

### Community 189 - "Community 189"
Cohesion: 0.29
Nodes (3): Synapsis.Encrypted.Binary, derive_key(), load()

### Community 190 - "Community 190"
Cohesion: 0.39
Nodes (5): Synapsis.Heartbeats, create(), cron_error_changeset(), update(), validate_cron_semantic()

### Community 192 - "Community 192"
Cohesion: 0.46
Nodes (7): Synapsis.Agent.ProjectContextBuilder, build(), build_board_summary(), build_devlog_tail(), build_repo_summary(), empty_board_summary(), parse_board_content()

### Community 193 - "Community 193"
Cohesion: 0.43
Nodes (7): Synapsis.Agent.QueryLoop.Executor, append_to_batches(), concurrent_safe?(), format_result(), partition(), run(), run_one()

### Community 195 - "Community 195"
Cohesion: 0.36
Nodes (5): Synapsis.Session.DebugTelemetry, handle_event(), serialize_for_channel(), serialize_list(), store_available?()

### Community 196 - "Community 196"
Cohesion: 0.36
Nodes (6): Synapsis.Session.AuditorTask, build_auditor_request(), build_user_message(), next_attempt_number(), prepare_escalation(), record_analysis()

### Community 197 - "Community 197"
Cohesion: 0.39
Nodes (6): Synapsis.Workspace.Permissions, check(), check_role(), gate_action(), own_project?(), own_session?()

### Community 200 - "Community 200"
Cohesion: 0.39
Nodes (6): Owl.MixProject, deps(), docs(), elixirc_paths(), package(), project()

### Community 201 - "Community 201"
Cohesion: 0.39
Nodes (6): Finch.MixProject, deps(), docs(), elixirc_paths(), package(), project()

### Community 202 - "Community 202"
Cohesion: 0.39
Nodes (6): ThousandIsland.MixProject, deps(), dialyzer(), docs(), elixirc_paths(), project()

### Community 203 - "Community 203"
Cohesion: 0.36
Nodes (5): Expo.MixProject, deps(), docs(), package(), project()

### Community 204 - "Community 204"
Cohesion: 0.39
Nodes (6): Phoenix.PubSub.Mixfile, deps(), docs(), elixirc_paths(), package(), project()

### Community 205 - "Community 205"
Cohesion: 0.39
Nodes (6): CCPrecompiler.MixProject, deps(), docs(), links(), package(), project()

### Community 206 - "Community 206"
Cohesion: 0.36
Nodes (5): MakeupErlang.Mixfile, deps(), description(), package(), project()

### Community 207 - "Community 207"
Cohesion: 0.39
Nodes (6): Crontab.Mixfile, deps(), description(), docs(), package(), project()

### Community 208 - "Community 208"
Cohesion: 0.39
Nodes (6): Fine.MixProject, aliases(), deps(), docs(), package(), project()

### Community 209 - "Community 209"
Cohesion: 0.39
Nodes (6): Bandit.MixProject, deps(), dialyzer(), docs(), elixirc_path(), project()

### Community 210 - "Community 210"
Cohesion: 0.43
Nodes (5): SynapsisCore.MixProject, aliases(), deps(), elixirc_paths(), project()

### Community 211 - "Community 211"
Cohesion: 0.43
Nodes (5): Synapsis.PromptBuilder, build_failure_context(), build_memory_context(), build_prompt_context(), format_failure_block()
...
Cohesion: 0.48
Nodes (6): Synapsis.Session.Worker.Boot, boot(), load_and_boot(), normalize_project_path(), reset_transient_status(), setup_worktree()
...
## Knowledge Gaps
- **306 isolated node(s):** `Synapsis.Agent.ToolDispatcherTest`, `SynapsisWeb.SettingsLiveTest`, `SynapsisCore`, `Synapsis.Tool.Behaviour`, `SessionCreated` (+301 more)
...
- **Why does `add()` connect `Community 54` to `Community 384`, `Community 385`, `Community 386`, `Community 387`, `Community 388`, `Community 389`, `Community 390`, `Community 391`, `Community 392`, `Community 393`, `Community 394`, `Community 395`, `Community 396`, `Community 397`, `Community 398`, `Community 399`, `Community 158`, `Community 320`, `Community 368`, `Community 369`, `Community 370`, `Community 371`, `Community 372`, `Community 373`, `Community 374`, `Community 375`, `Community 376`, `Community 377`, `Community 378`, `Community 379`, `Community 380`, `Community 381`, `Community 382`, `Community 383`?**
...
- **What connects `Synapsis.Agent.ToolDispatcherTest`, `SynapsisWeb.SettingsLiveTest`, `SynapsisCore` to the rest of the system?**
