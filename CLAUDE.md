...
This project is indexed by GitNexus as **Synapsis** (2652 symbols, 2856 relationships, 18 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
